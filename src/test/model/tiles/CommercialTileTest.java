...
public class CommercialTileTest {
    ...
    public void testInit() {
        ...
        Assert.assertEquals(CommercialTile.DEFAULT_PRODUCTS_CAPACITY, ct.getProductsCapacity());
        ct = new CommercialTile(10);
        Assert.assertEquals(10, ct.getProductsCapacity());
	}
	...
	public void testUpdate() {
		...
		ct.update(res);
		int product = res.getProductsCount() * (ct.getProductsCapacity() * 100 / res.getProductsCapacity()) / 100;
		int busyPercentage = product * 100 / ct.getProductsCapacity();
	...
	public void testDisassemble(){
		...
		ct.update(resources);
		int product = resources.getProductsCount()*(ct.getProductsCapacity() * 100 / resources.getProductsCapacity())/100;
		int busyPercentage = product * 100 / ct.getProductsCapacity();
		int neededEnergy = Math.max(1, busyPercentage * ct.getMaxNeededEnergy() / 100);
