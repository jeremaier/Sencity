...
public final class PoliceStationZoneDelimiterTool extends Tool {
	// Constant
	...
	public boolean equals (Object o) {
		return this == o || o instanceof PoliceStationZoneDelimiterTool;
	}

	/**
     * isAfordable returns true if the user can apply the PoliceStation Tool, false
     * otherwise.
     */
	@Override
	public boolean isAfordable(Tile aTarget, CityResources r) {
		return PoliceStationZoneDelimiterTool.CURRENCY_COST <= r.getCurrency();
	}
	...
	public boolean isCorrespondantTile(Tile aTarget) {
		return aTarget instanceof PoliceStationTile;
	}

	// Access
	@Override
	public int getCost (Tile aTarget) {
		return PoliceStationZoneDelimiterTool.CURRENCY_COST;
	}
	...
	/**
     * innerEffect apply the PoliceStation tool to the given tile and update the
     * given CityResources.
     */
	@Override
